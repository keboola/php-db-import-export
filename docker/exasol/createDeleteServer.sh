...
getDb(){
    curl -vvv -X GET "$EXA_SAAS_HOST/api/v1/accounts/$EXA_SAAS_USER_ID/databases/$1" -H "accept: application/json" -H "Authorization: Bearer $EXA_SAAS_TOKEN"
}
getClusters(){
    curl -vvv -X GET "$EXA_SAAS_HOST/api/v1/accounts/$EXA_SAAS_USER_ID/databases/$1/clusters" -H "accept: application/json" -H "Authorization: Bearer $EXA_SAAS_TOKEN"
}
getConnectionData(){
    curl -vvv -X GET "$EXA_SAAS_HOST/api/v1/accounts/$EXA_SAAS_USER_ID/databases/$1/clusters/$2/connect" -H "accept: application/json" -H "Authorization: Bearer $EXA_SAAS_TOKEN"
}
