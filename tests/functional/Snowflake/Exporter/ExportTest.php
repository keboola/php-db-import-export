...
class ExportTest extends SnowflakeBaseTestCase
{
    ...
    public function testExportParquet(): void
    {
        $this->initTable(self::TABLE_OUT_CSV_2COLS);
        // import
        $file = new CsvFile(self::DATA_DIR . 'with-ts.csv');
        ...
        // export
        $source = $destination;
        $options = new ExportOptions(false, ExportOptions::MANIFEST_AUTOGENERATED, ExportOptions::EXPORT_FILE_TYPE_PARQUET);
        ...
        $this->assertSame('parquet_test_0_0_0.snappy.parquet', $slice['FILE_NAME']);
        $this->assertNotEmpty($slice['FILE_SIZE']);
        $this->assertSame(2, (int) $slice['ROW_COUNT']);
